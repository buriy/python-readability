...
The user corpus contains saved pages from reproducible GitHub issue reports: three open and three closed issues. `ideal.html` is built from the semantic content containers recorded in `metadata.json`, independently of the compared extraction engines.
...
| closed-30-macrumors-inline | [#30](https://github.com/buriy/python-readability/issues/30) | closed | www.macrumors.com | 0.655 |
